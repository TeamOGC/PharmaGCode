...
public class PDFCreator {
    ...
    public static void creaPDF(Collo collo) throws IOException, DocumentException {
        ...
        PdfWriter.getInstance(document, new FileOutputStream("/home/"+user+"/Documents/PharmaGCode/PharmaGCode/PharmaGCode/pdf/Ricevuta di consegna n." + foo + ".pdf"));
        document.open();
        aggiungiMetadati(document);
        aggiungiTitolo(document, collo);
        creaTabella(document, collo);
        document.close();
        File file = new File("/home/"+user+"/Documents/PharmaGCode/PharmaGCode/PharmaGCode/pdf/Ricevuta di consegna n." + foo + ".pdf");
        openFile(file);
